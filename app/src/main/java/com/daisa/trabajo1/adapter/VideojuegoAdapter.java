package com.daisa.trabajo1.adapter;
...
public class VideojuegoAdapter extends BaseAdapter {
    ...
    public VideojuegoAdapter(Context contexto, ArrayList<Videojuego> videojuegos){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //viewholder.imagen.setImageBitmap(Util.getBitmap(videojuego.getImagen()));
